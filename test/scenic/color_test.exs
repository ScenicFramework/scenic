defmodule Scenic.ColorTest do
  ...
  test "to_rgb explicit" do
    ...
    assert Color.to_rgb({:color_rgba, {0xFF, 0xE4, 0xC4, 200}}) == {:color_rgb, {0xFF, 0xE4, 0xC4}}
  ...
  test "to_rgba explicit" do
    ...
    assert Color.to_rgba({:color_rgb, {0xFF, 0xE4, 0xC4}}) == {:color_rgba, {0xFF, 0xE4, 0xC4, 0xFF}}
    assert Color.to_rgba({:color_rgba, {0xFF, 0xE4, 0xC4, 200}}) == {:color_rgba, {0xFF, 0xE4, 0xC4, 200}}
  ...
  test ":antique_white", do: assert Color.to_rgb(:antique_white) == {:color_rgb, {0xFA, 0xEB, 0xD7}}
  ...
  test ":blanched_almond", do: assert Color.to_rgb(:blanched_almond) == {:color_rgb, {0xFF, 0xEB, 0xCD}}
  ...
  test ":cornflower_blue", do: assert Color.to_rgb(:cornflower_blue) == {:color_rgb, {0x64, 0x95, 0xED}}
  ...
  test ":dark_golden_rod", do: assert Color.to_rgb(:dark_golden_rod) == {:color_rgb, {0xB8, 0x86, 0x0B}}
  ...
  test ":dark_magenta", do: assert Color.to_rgb(:dark_magenta) == {:color_rgb, {0x8B, 0x00, 0x8B}}
  test ":dark_olive_green", do: assert Color.to_rgb(:dark_olive_green) == {:color_rgb, {0x55, 0x6B, 0x2F}}
  ...
  test ":dark_sea_green", do: assert Color.to_rgb(:dark_sea_green) == {:color_rgb, {0x8F, 0xBC, 0x8F}}
  test ":dark_slate_blue", do: assert Color.to_rgb(:dark_slate_blue) == {:color_rgb, {0x48, 0x3D, 0x8B}}
  test ":dark_slate_gray", do: assert Color.to_rgb(:dark_slate_gray) == {:color_rgb, {0x2F, 0x4F, 0x4F}}
  test ":dark_slate_grey", do: assert Color.to_rgb(:dark_slate_grey) == {:color_rgb, {0x2F, 0x4F, 0x4F}}
  test ":dark_turquoise", do: assert Color.to_rgb(:dark_turquoise) == {:color_rgb, {0x00, 0xCE, 0xD1}}
  ...
  test ":deep_sky_blue", do: assert Color.to_rgb(:deep_sky_blue) == {:color_rgb, {0x00, 0xBF, 0xFF}}
  ...
  test ":floral_white", do: assert Color.to_rgb(:floral_white) == {:color_rgb, {0xFF, 0xFA, 0xF0}}
  test ":forest_green", do: assert Color.to_rgb(:forest_green) == {:color_rgb, {0x22, 0x8B, 0x22}}
  ...
  test ":green_yellow", do: assert Color.to_rgb(:green_yellow) == {:color_rgb, {0xAD, 0xFF, 0x2F}}
  ...
  test ":lavender_blush", do: assert Color.to_rgb(:lavender_blush) == {:color_rgb, {0xFF, 0xF0, 0xF5}}
  test ":lawn_green", do: assert Color.to_rgb(:lawn_green) == {:color_rgb, {0x7C, 0xFC, 0x00}}
  test ":lemon_chiffon", do: assert Color.to_rgb(:lemon_chiffon) == {:color_rgb, {0xFF, 0xFA, 0xCD}}
  ...
  test ":light_golden_rod", do: assert Color.to_rgb(:light_golden_rod) == {:color_rgb, {0xFA, 0xFA, 0xD2}}
  test ":light_golden_rod_yellow", do: assert Color.to_rgb(:light_golden_rod_yellow) == {:color_rgb, {0xFA, 0xFA, 0xD2}}
  ...
  test ":light_salmon", do: assert Color.to_rgb(:light_salmon) == {:color_rgb, {0xFF, 0xA0, 0x7A}}
  test ":light_sea_green", do: assert Color.to_rgb(:light_sea_green) == {:color_rgb, {0x20, 0xB2, 0xAA}}
  test ":light_sky_blue", do: assert Color.to_rgb(:light_sky_blue) == {:color_rgb, {0x87, 0xCE, 0xFA}}
  test ":light_slate_gray", do: assert Color.to_rgb(:light_slate_gray) == {:color_rgb, {0x77, 0x88, 0x99}}
  test ":light_steel_blue", do: assert Color.to_rgb(:light_steel_blue) == {:color_rgb, {0xB0, 0xC4, 0xDE}}
  test ":light_yellow", do: assert Color.to_rgb(:light_yellow) == {:color_rgb, {0xFF, 0xFF, 0xE0}}
  ...
  test ":medium_aqua_marine", do: assert Color.to_rgb(:medium_aqua_marine) == {:color_rgb, {0x66, 0xCD, 0xAA}}
  test ":medium_blue", do: assert Color.to_rgb(:medium_blue) == {:color_rgb, {0x00, 0x00, 0xCD}}
  test ":medium_orchid", do: assert Color.to_rgb(:medium_orchid) == {:color_rgb, {0xBA, 0x55, 0xD3}}
  test ":medium_purple", do: assert Color.to_rgb(:medium_purple) == {:color_rgb, {0x93, 0x70, 0xDB}}
  test ":medium_sea_green", do: assert Color.to_rgb(:medium_sea_green) == {:color_rgb, {0x3C, 0xB3, 0x71}}
  test ":medium_slate_blue", do: assert Color.to_rgb(:medium_slate_blue) == {:color_rgb, {0x7B, 0x68, 0xEE}}
  test ":medium_spring_green", do: assert Color.to_rgb(:medium_spring_green) == {:color_rgb, {0x00, 0xFA, 0x9A}}
  test ":medium_turquoise", do: assert Color.to_rgb(:medium_turquoise) == {:color_rgb, {0x48, 0xD1, 0xCC}}
  test ":medium_violet_red", do: assert Color.to_rgb(:medium_violet_red) == {:color_rgb, {0xC7, 0x15, 0x85}}
  test ":midnight_blue", do: assert Color.to_rgb(:midnight_blue) == {:color_rgb, {0x19, 0x19, 0x70}}
  ...
  test ":navajo_white", do: assert Color.to_rgb(:navajo_white) == {:color_rgb, {0xFF, 0xDE, 0xAD}}
  ...
  test ":pale_golden_rod", do: assert Color.to_rgb(:pale_golden_rod) == {:color_rgb, {0xEE, 0xE8, 0xAA}}
  test ":pale_green", do: assert Color.to_rgb(:pale_green) == {:color_rgb, {0x98, 0xFB, 0x98}}
  test ":pale_turquoise", do: assert Color.to_rgb(:pale_turquoise) == {:color_rgb, {0xAF, 0xEE, 0xEE}}
  test ":pale_violet_red", do: assert Color.to_rgb(:pale_violet_red) == {:color_rgb, {0xDB, 0x70, 0x93}}
  ...
  test ":rebecca_purple", do: assert Color.to_rgb(:rebecca_purple) == {:color_rgb, {0x66, 0x33, 0x99}}
  ...
  test ":saddle_brown", do: assert Color.to_rgb(:saddle_brown) == {:color_rgb, {0x8B, 0x45, 0x13}}
  ...
  test ":spring_green", do: assert Color.to_rgb(:spring_green) == {:color_rgb, {0x00, 0xFF, 0x7F}}
  ...
  test ":yellow_green", do: assert Color.to_rgb(:yellow_green) == {:color_rgb, {0x9A, 0xCD, 0x32}}
