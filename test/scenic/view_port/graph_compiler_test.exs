...
defmodule Scenic.ViewPort.GraphCompilerTest do
  ...
  test "simple_text graph works" do
    graph = Graph.build( font: :roboto, font_size: 27 )
      |> text( "blue", fill: :blue)
  ...
  test "simple_theme graph works" do
    graph = Graph.build( font: :roboto, font_size: 26, theme: :dark )
      |> text( "theme" )
  ...
  test "pinned transforms graph works" do
    graph = Graph.build( fill: :yellow, stroke: {3, :purple} )
  ...
  test "line_styles graph works" do
    graph = Graph.build(stroke: {2, :green})
  ...
  test "join_styles graph works" do
    graph = Graph.build(stroke: {1, :green})
  ...
  test "fill_gradients graph works" do
    ...
    assert list == [
      {:fill_linear, {1.0, 2.0, 3.0, 4.0, {:color_rgba, {255, 0, 0, 255}}, {:color_rgba, {0, 128, 0, 255}}}},
      {:draw_rect, {100.0, 200.0, :fill}},
      {:fill_radial, {10.0, 20.0, 1.0, 2.0, {:color_rgba, {0, 0, 255, 255}}, {:color_rgba, {128, 0, 128, 255}}}},
      {:draw_rect, {100.0, 200.0, :fill}}
    ]
  end
  ...
  test "stroke_gradients graph works" do
    ...
    assert list == [
      {:stroke_width, 1},
      {:stroke_linear, {1, 2, 3, 4, {:color_rgba, {255, 0, 0, 255}}, {:color_rgba, {0, 128, 0, 255}}}},
      {:draw_rect, {100, 200, :stroke}},
      {:stroke_width, 2},
      {:stroke_radial, {10, 20, 1, 2, {:color_rgba, {0, 0, 255, 255}}, {:color_rgba, {128, 0, 128, 255}}}},
      {:draw_rect, {100, 200, :stroke}},
      {:stroke_width, 7},
      {:stroke_linear, {1, 2, 3, 4, {:color_rgba, {255, 0, 0, 255}}, {:color_rgba, {0, 128, 0, 255}}}},
      {:draw_rect, {100, 200, :stroke}},
  ...
  test "min_font_size only renders the used font/size" do
    graph = Graph.build(font: :roboto_mono, font_size: 25)
  ...
  test "root_font_size uses the root settings" do
    graph = Graph.build(font: :roboto, font_size: 25)
      |> text( "text" )
  ...
  test "text_from_spec works" do
    ...
    graph = Graph.build(font: :roboto, font_size: 24)
           |> add_specs_to_graph(
             [ group_spec(text_spec, font_size: 40) ]
           )
