...
defmodule Scenic.Math.LineTest do
  ...
  test "trunc(x,y) works" do
    assert Line.trunc({{1.1, 2.8}, {2.1, 3.3}}) == {{1, 2}, {2, 3}}
  end

  test "trunc(x,y,z) works" do
    assert Line.trunc({{1.1, 2.8, 3.2}, {2.1, 3.8, 4.7}}) == {{1, 2, 3}, {2, 3, 4}}
  end

  # ----------------------------------------------------------------------------
  # round  
  test "round(x,y) works" do
    assert Line.round({{1.1, 2.8}, {2.1, 3.3}}) == {{1, 3}, {2, 3}}
  end

  test "round(x,y,z) works" do
    assert Line.round({{1.1, 2.8, 3.2}, {2.1, 3.8, 4.7}}) == {{1, 3, 3}, {2, 4, 5}}
  end
