...
defmodule Scenic.Math.Vector do
  ...
  def build(x, y, z) when is_number(x) and is_number(y) and is_number(z) do
    {x, y, z}
  end

  def build(x, y, z, w) when is_number(x) and is_number(y) and is_number(z) and is_number(w) do
    {x, y, z, w}
  end
