...
defmodule Scenic.Math.Rectangle do
  ...
  def build(%{left: left, top: top, right: right, bottom: bottom}),
    do: {left, top, right - left, bottom - top}
  ...
  def intersect(rect_a, rect_b) do
    ...
    cond do
      # calc interior width and height
      min_right > max_x && min_bottom > max_y ->
