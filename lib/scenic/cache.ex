...
#  import IEx
  ...
  def request_notification( @cache_put ),     do: Registry.register( @cache_registry, @cache_put, @cache_put )
  def request_notification( @cache_delete ),  do: Registry.register( @cache_registry, @cache_delete, @cache_delete )
  def request_notification( @cache_claim ),   do: Registry.register( @cache_registry, @cache_claim, @cache_claim )
  def request_notification( @cache_release ), do: Registry.register( @cache_registry, @cache_release, @cache_release )
