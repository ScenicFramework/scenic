...
defmodule Scenic.Animation do
  ...
  defp tick_animation(graph, elapsed_time, {tick_action, _}, data)
       when is_function(tick_action, 3) do
  ...
  defp stop_animation(graph, elapsed_time, {_, stop_action}, data)
       when is_function(stop_action, 3) do
