...
#  import IEx
  ...
  defp insert_at({%Graph{primitives: primitives} = graph, parent_uid},
  index, %Primitive{} = primitive, _opts)
  when is_integer(index) do
    ...
    graph = case Map.get(primitive, :id) do
      nil -> graph
